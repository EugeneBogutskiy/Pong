...
public class ANN{
	...
	/// 
	/// </summary>
	/// <param name="nI">number of input neurons</param>
	/// <param name="nO">number of output neurons </param>
	/// <param name="nH">number of hidden layers</param>
	/// <param name="nPH">number of neurons in hidden layers</param>
	/// <param name="a">learning rate alpha (1.0 - 100%, 0.1 - 10%) how fast will learn</param>
	...
	{
		return TanH(value); // TanH lets us use -1 to 1 
	}
